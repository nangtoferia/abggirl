...
export default async function Video({ params }: PageProps) {
    ...
    const file = data.result[0];
        ...
        url: `https://abggirl.pages.dev/v/${file.filecode}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://abggirl.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://abggirl.pages.dev'
              },
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://abggirl.pages.dev/v/${file.filecode}`
            }  
        }
        }
        const jsonLd3 = {
